...
mkdir -p /var/folders/r4/c2kvh3zs7230vndy5xy0rkg40000gp/T/tmpocas2eks/output

# Run the benchmark
echo "Running benchmark: hello_world"
/var/folders/r4/c2kvh3zs7230vndy5xy0rkg40000gp/T/tmpocas2eks/output/hello_world 
