...
examples/output/hello_world_bench_1740762309_xm98nb/build/hello_world 

# Save output to results directory
echo "Results saved to: examples/output/hello_world_bench_1740762309_xm98nb/results"
