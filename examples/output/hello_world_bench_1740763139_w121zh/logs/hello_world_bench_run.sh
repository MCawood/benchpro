...
examples/output/hello_world_bench_1740763139_w121zh/build/hello_world 

# Save output to results directory
echo "Results saved to: examples/output/hello_world_bench_1740763139_w121zh/results"
